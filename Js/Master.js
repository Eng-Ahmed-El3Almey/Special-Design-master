...
if (mainColors !== null) {
  // console.log('Locsl Storagee Is Not Empty You Can Set On Root Now');
  ...
  document.querySelectorAll(".Colors-list li").forEach((element) => {
    ...
    // Add Class Active On Element With Data Color === Local Storage Data
...
document.querySelector(".toggle-settings .fa-gear").onclick = function () {
  ...
  // Toggle Class Opem On Main Setting Box
  ...
  if (backgroundOption === true) {
    backgrounInterval = setInterval(() => {
      ...
      landingPage.style.backgroundImage =
        'url("images/' + imgsArry[randomNumber] + '")';
    }, 1000);
  }
}
...
function scrollSameWhere(elements) {
...
scrollSameWhere(allBulets);
scrollSameWhere(allLinks);
...
// Click Anywhere Outsite Menu And Toggle Button
